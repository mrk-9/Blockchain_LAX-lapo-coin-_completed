...
void MasternodeList::setBitcoinGUI(BitcoinGUI* gui)
{
    this->gui = gui;
}
...
void MasternodeList::on_WizardButton_clicked()
{
    MasternodeWizard *wizard = new MasternodeWizard(this);
    wizard->setBitcoinGUI(gui);
    wizard->show();
}
