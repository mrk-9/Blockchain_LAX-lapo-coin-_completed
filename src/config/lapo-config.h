/* src/config/lapo-config.h.  Generated from lapo-config.h.in by configure.  */
/* src/config/lapo-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "lapo.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lapo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lapo Core 1.2.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lapo"
