...
int64_t GetSubsidy(int nHeight)
{
    ...
    } else if (nHeight < 795500) {     // PoW + PoS
        nSubsidy = 2500 * COIN;
    } else if (nHeight < 838701) {     // PoS onewards
        nSubsidy = 2500 * COIN;
    } else if (nHeight < 925102) {
        nSubsidy = 2250 * COIN;
    } else if (nHeight < 1054703) {
        nSubsidy = 2000 * COIN;
    } else if (nHeight < 1270704) {
        nSubsidy = 1750 * COIN;
    } else if (nHeight < 1616305) {
        nSubsidy = 1500 * COIN;
    } else if (nHeight < 2177906) {
        nSubsidy = 1250 * COIN;
    } else if (nHeight < 3085107) {
        nSubsidy = 1000 * COIN;
    } else if (nHeight < 4553908) {
        nSubsidy = 750 * COIN;
    } else if (nHeight < 6929909) {
        nSubsidy = 500 * COIN;
    } else {
...
{
    {
        ...
        if (!pto->fDisconnect && state.vBlocksInFlight.size() > 0 && state.vBlocksInFlight.front().nTime < nNow - 500000 * Params().TargetSpacing1() * (4 + state.vBlocksInFlight.front().nValidatedQueuedBefore)) {
