...
pkgdatadir = $(datadir)/lapo
pkgincludedir = $(includedir)/lapo
pkglibdir = $(libdir)/lapo
pkglibexecdir = $(libexecdir)/lapo
...
CONFIG_HEADER = $(top_builddir)/src/config/lapo-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/lapo-config.h.in \
...
ACLOCAL = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
BITCOIN_CLI_NAME = lapo-cli
BITCOIN_DAEMON_NAME = lapod
BITCOIN_GUI_NAME = lapo-qt
BITCOIN_TX_NAME = lapo-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = lapo
PACKAGE_BUGREPORT = lapo.io
PACKAGE_NAME = Lapo Core
PACKAGE_STRING = Lapo Core 1.2.5
PACKAGE_TARNAME = lapo
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master
abs_srcdir = /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master
abs_top_builddir = /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master
abs_top_srcdir = /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ksk/Works/2019/2019-01/2019-01-10_LAPO-coin/Ubuntu_works/LAPO-Blockchain-master/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_lapo_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_lapo_coverage.info test_lapo.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/LAPO-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/lapo-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/lapo-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/lapo-config.h
$(top_srcdir)/src/config/lapo-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/lapo-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/LAPO-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LAPO-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LAPO-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_lapo.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_lapo -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_lapo_filtered.info: test_lapo.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_lapo_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_lapo_coverage.info: baseline_filtered_combined.info test_lapo_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_lapo_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_lapo_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_lapo_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_lapo.coverage/.dirstamp:  test_lapo_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_lapo.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_lapo.coverage/ total.coverage/ $(OSX_APP)
